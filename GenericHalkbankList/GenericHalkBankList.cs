...
{
    public class GenericHalkBankList<T> : IMyEnumerable
    {
        protected T[] _dizi;

        public GenericHalkBankList()
        {
            _dizi = new T[0];
        }

        public GenericHalkBankList(int maxElemanSayisi) : this()
        {
        ...
        public IMyEnumerable.GetEnumerator() => new Iterasyon(this);
    }
